...
In order to further advance on the plant happiness project, the following research indicates the next steps (please find related literature, sources, and the full concept link at the end of this article).
