...
What works well:
- **Slack/chat** for quick questions, status updates, and informal coordination
- **Email** for anything that needs a paper trail or requires thoughtful response
- **Video calls** for complex discussions, brainstorming, or sensitive topics
- **Documents** for proposals, designs, or anything that benefits from async review

What doesn't work:
- Expecting immediate responses outside work hours (I protect my personal time)
- Long email threads that should have been a 10-minute call
- Ambiguous messages that require multiple rounds of clarification
...
- Separate the idea from the person—I can handle criticism of my work without taking it personally
- Give me time to respond; I process feedback better when I can reflect
...
- Communicating proactively, especially when things go wrong
- Being honest about uncertainty or mistakes
- Respecting work-life boundaries
- Following through on commitments, even small ones

**Trust is eroded by:**
- Overpromising and underdelivering
- Providing vague updates that obscure the real status
- Saying yes when you mean no (or maybe)
- Taking credit for others' work
- Being unreliable on deadlines without communication
...
Specifically:
- **Deep technical work** where I can focus for extended periods
- **Ambiguous problems** that require creative solutions
- **Cross-functional collaboration** where I learn from people with different expertise
- **Shipping things** that users actually use and benefit from
- **Learning new domains** and applying technical skills in novel contexts
...
Specific stressors:
- **Meetings that should have been emails** (or docs, or Slack messages)
- **Unclear ownership** where nobody knows who's responsible for what
- **Constant context-switching** that prevents deep work
- **Politics over substance** where decisions are made for reasons other than merit
- **Unrealistic deadlines** set without input from the people doing the work
...
More specifically:
- **Technical depth** in machine learning, NLP, and AI systems
- **Analytical thinking** that breaks complex problems into tractable pieces
- **Written communication** that clarifies and persuades
- **Execution discipline** that turns plans into shipped products
- **Learning agility** that lets me pick up new domains quickly
...
I'm also working on:
- **Patience with ambiguity** when the path forward isn't clear
- **Delegating more** instead of doing everything myself
- **Building relationships** with people outside my immediate team
- **Saying no** to protect focus time
...
More specifically:
- **Follow through** on commitments or communicate early if you can't
- **Be direct** about disagreements rather than going around me
- **Share context** that helps me do my job better
- **Respect focus time** and don't expect instant responses to non-urgent requests
- **Bring solutions** along with problems when possible
...
- Right people in the room (and no one extra)
- Decisions made or next steps assigned before ending
- Notes captured and shared

What makes a bad meeting:
- No agenda or unclear purpose
- Too many people, most of whom are silent
- Discussion that goes in circles without resolution
- No clear outcomes or follow-ups
